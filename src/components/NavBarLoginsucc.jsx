...
const NavBar = () => {
  ...
  return (
    <div
      ...
      className="flex justify-between items-center py-6 z-10 relative "
    >
      {/* LogoImage */}
      ...
      <div className="flex gap-5">
        ...
        <div className="bg-[#3431BB] rounded-[13px]">
          <button
            className="bg-none text-white px-4 py-2 rounded-lg flex items-center justify-center text-center hover:text-gray-300 transition duration-300"
