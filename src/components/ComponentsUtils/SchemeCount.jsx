...
function SchemeCount(dataFromApi){
  ...
  const {states, setStates, departments, setDepartments, beneficiaries, setBeneficiaries, sponsoredBy, setsponsoredBy} = useContext(FilterContext);
