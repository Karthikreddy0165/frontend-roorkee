      ...
      <footer className="text-black py-8 px-4 gap-5 sm:mt-[10rem] ">
        <div className="max-w-screen-xl mx-auto flex flex-wrap justify-between space-y-8 md:space-y-0 gap-8">
          ...
          <div className="flex-1 md:max-w-[40%]">
            <h1 className="text-lg font-semibold mb-5 text-[#3F3BE1]">
              LaunchPad
            </h1>
          ...
          <div className="flex-1 md:max-w-[20%] mr-[5px]">
            <h4 className="text-lg font-semibold mb-4 text-[#3F3BE1]">
              Navigation
            </h4>
          ...
          <div className="flex-1 md:max-w-[30%]">
            ...
            <div className="flex space-x-4">
              <a
                ...
                className=" p-2 rounded-full w-10 h-10 flex items-center justify-center hover:bg-blue-500"
              >
                <svg
                  width="25"
                  height="25"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className=" p-2 rounded-full w-10 h-10 flex items-center justify-center hover:bg-gray-700"
              >
                <svg
                  width="25"
                  height="25"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className=" p-2 rounded-full w-10 h-10 flex items-center justify-center hover:bg-pink-500"
              >
                <svg
                  width="25"
                  height="25"
