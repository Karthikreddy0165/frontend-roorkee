...
const Footer = () => {
  ...
  return (
    <>
      <footer className="text-black bg-[#343435] sm:pt-[5rem] pb-[1rem] px-4 gap-[5rem]  sm:py-[2rem] ">
        <h1 className="text-[32px] block sm:hidden font-semibold mb-4 text-[#F58220]">
          Empower Hub
        </h1>
        ...
        <div className="max-w-screen-xl mx-auto flex flex-wrap justify-between space-y-8 md:space-y-0 gap-8">
          ...
          <div className="flex-1 md:max-w-[40%] hidden sm:block">
            <h1 className="text-[32px] font-semibold mb-4 text-[#F58220]">
              Empower Hub
            </h1>
            <h1 className="text-lg font-bold mb-4 text-[#FFFFFF]">Follow Us</h1>
          ...
          <div className="flex-1 md:max-w-[20%] mr-[5px]">
            <h4 className="text-[20px] font-semibold mb-4 text-[#F58220]">
              Navigation
            </h4>
            <ul className="space-y-2">
              ...
              {displayText.includes("schemes") && (
                <li>
                  <a href="AllSchemes?tab=schemes" className="text-[#FFFFFF] ">
                    Schemes
                  </a>
                </li>
              )}
