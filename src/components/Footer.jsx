const Footer = () => {
  return (
    <>
      <footer className="bg-[#3431BB] text-white py-8 px-4 gap-5">
            ...
            <div className="flex space-x-4">
              ...
              >
                <svg
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <g clip-path="url(#clip0_990_1770)">
                    <path
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-pink-600 p-2 rounded-full w-10 h-10 flex items-center justify-center hover:bg-pink-500"
              >
                <svg
                  width="25"
                  height="25"
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                >
                  <g clip-path="url(#clip0_990_1775)">
                    <path
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="bg-blue-700 p-2 rounded-full w-10 h-10 flex items-center justify-center hover:bg-blue-600"
              >
                <svg
                  width="25"
                  height="25"
