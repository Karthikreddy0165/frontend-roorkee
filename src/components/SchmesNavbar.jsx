...
const NavBarScheme = () => {
  ...
  const { setActiveTab, query, setquery } = useTabContext();
  ...
  return (
    <nav className="bg-white shadow-sm">
      ...
      <div className="mx-auto sm:px-10 lg:px-[70px] md:px-[50px] px-4 py-2 flex justify-between items-center">
        {/* Logo */}
        <div
        ...
        <div className="hidden md:flex items-center w-full ">
          <div className="flex sm:gap-1 md:gap-4 lg:gap-4 xl:gap-6 ml-auto sm:mr-0 md:mr-7 xl:mr-7 lg:mr-7">
            {/* Home Link */}
            <a
              href="/"
              className={`text-black transition duration-300 text-[16px] font-semibold underline-offset-8 ${
        ...
        <div className="flex lg:block md:block hidden   items-center  ">
          {authState.token ? (
        ...
        <div className="md:hidden flex items-center gap-4">
          ...
          <div className="relative py-4">
            {showSearch ? (
              <div className="absolute right-0 top-0 p-2  bg-white border border-gray-300 rounded-lg z-20 flex items-center w-[180px]">
                <input
                  type="text"
                  placeholder="Search..."
              ...
              <div className="flex items-center">
                <ToolTips tooltip="Search for schemes, job openings & scholarships" />
                <IoSearchOutline
          ...
          {/* Mobile Menu Button */}
          <button className="p-2 text-gray-600" onClick={toggleSidebar}>
        ...
        <div className="md:hidden fixed inset-0 z-50">
          ...
          <div className="absolute left-0 top-0 h-full w-64 bg-white shadow-lg">
            ...
            <div className="p-4 overflow-y-auto h-[calc(100%-60px)]">
              {/* Home Button */}
              <button
                className="w-full text-left p-3 hover:bg-gray-100 rounded flex items-center gap-3"
                onClick={handleClickLogo}
              >
                <svg
                  width="20"
