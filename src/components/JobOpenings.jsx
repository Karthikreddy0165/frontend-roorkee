...
export default function JobOpenings() {
  ...
  return (
    <div className="bg-white font-sans mt-0">
      <h1 className="mt-0 mb-[20px] font-bold text-[28px]">Job Openings</h1>
