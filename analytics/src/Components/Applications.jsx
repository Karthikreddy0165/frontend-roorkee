      ...
      >
        ...
        <div className="flex justify-center items-center my-10 mb-[200px]">
          ...
          >
            ...
            <option value="active">Total Applications</option>
            <option value="inactive">Applications per Category</option>
            <option value="Users by Caste Category">
              Most Applied Schemes
            </option>
            <option value="Users by Age Group">Application Success Rate</option>
          </select>
        </div>
        ...
        <div className="w-full h-96 mt-10 p-4 bg-white shadow-lg rounded-lg">
          ...
          <p className="mb-4">Most Applications</p>
